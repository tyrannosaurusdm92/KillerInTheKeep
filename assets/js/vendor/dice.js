...
const DICE = (function() {
    ...
    that.dice_box = function(container) {
        ...
        // Killer In The Keep uses the physical WebGL renderer only. The legacy
        // CanvasRenderer path is intentionally removed because modern Three.js
        // no longer ships it and silently falling into it disables immersive dice.
    ...
    function playSound(outerContainer, soundVolume) {
        ...
        var src = picked ? (picked.iframeUrl || picked.url || picked) : 'assets/nc93322.mp3';
